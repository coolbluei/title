...
class BundleConfigManager {
   ...
   * @param \Drupal\Core\Entity\EntityDisplayRepositoryInterface $entityDisplayManager
   *   The entity display manager.
   */
  public function __construct(protected readonly EntityTypeManagerInterface $entityTypeManager, protected readonly EntityDisplayRepositoryInterface $entityDisplayManager) {
  }
  ...
  public function getViewModeIds($entity_type) {
    $ids = [];
    $view_modes = $this->entityDisplayManager->getViewModes('node');
